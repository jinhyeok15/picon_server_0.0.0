...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, validators=[django.core.validators.RegexValidator('[가-힣a-zA-Z_\\-.]+', '이름이 올바른 형식이 아닙니다.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_pick', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_pick', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(default=1)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('from_follow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_follow', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(default=1)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('from_feed_back', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_feed_back', to=settings.AUTH_USER_MODEL)),
